...
# very easy fixed
python3 tools/train_vis_input_gnn.py --config config/tasks/Vis/ResNetGNN/veryeasy_200_fixed_e2e.yaml --exp veryeasy_200_fixed_e2e_gnn >> log_vis/veryeasy_200_fixed_e2e_gnn.log

python3 tools/train_vis_input_gnn.py --config config/tasks/Vis/ResNetGNN/veryeasy_200_fixed_modular2.yaml --modular --exp veryeasy_200_fixed_modular_gnn2 >> log_vis/veryeasy_200_fixed_modular_gnn2.log
